import { notNullish, nullish, numberProp, object, stringProp } from "./index.js";
...
describe("numberProp", () => {
  ...
  ])("allows %s", (_, value, prop) => expect(numberProp(value, prop)).toBeUndefined());
...
describe("stringProp", () => {
  it.each([
    ...
    ["object literal with numeric key", { 1: "2" }, 1],
    ["object literal with string key", { "1": "2" }, "1"],
  ])("allows %s", (_, value, prop) => expect(stringProp(value, prop)).toBeUndefined());
