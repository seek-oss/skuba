...
describe("packageModule", () => {
  it("works from scratch", async () => {
    ...
    const outputFiles = await executeModule(packageModule, inputFiles, defaultOpts);
  ...
  it("works from scratch for packages", async () => {
    ...
    const outputFiles = await executeModule(packageModule, inputFiles, defaultPackageOpts);
  ...
  it("overhauls seek-module-toolkit configuration", async () => {
    ...
    expect(outputData).toMatchObject({
      ...
      scripts: {
        ...
        format: "skuba format",
        lint: "skuba lint",
        release: "pnpm --silent run build && skuba release",
        start: "my-custom-script",
        test: "skuba test --coverage",
        "test:watch": "skuba test --watch",
      },
