...
import { formatOxfmt } from "../processing/oxfmt.js";
...
export const RENOVATE_CONFIG_FILENAMES = [".github/renovate.json5", ...OTHER_CONFIG_FILENAMES];
  ...
  return {
    ...
    ".github/renovate.json5": (_inputFile, _files, initialFiles) => {
      ...
      return inputFile?.includes("seek")
        ? formatOxfmt(".github/renovate.json5", inputFile)
        : configFile;
    },
