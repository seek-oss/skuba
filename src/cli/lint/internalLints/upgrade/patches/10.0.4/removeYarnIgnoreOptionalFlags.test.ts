    ...
    it("should handle a variety of formats", async () => {
      const inputVolume = {
        ...
        "Dockerfile.newline-with-more-after":
          "RUN yarn install \\\n --ignore-optional\\\n --other-arg\n",
        "Dockerfile.newline-multiple-args": "RUN yarn install \\\n --ignore-optional --other-arg\n",
      };
        ...
        mode === "lint"
          ...
          : {
              "Dockerfile.no":
                "yarn\nRUN stuff --ignore-optional\n RUN other-stuff \\\n --ignore-optional\n",
              "Dockerfile.oneline": "# stuff\nRUN yarn install\n# other-stuff\n",
              "Dockerfile.other-args": "RUN yarn install --frozen-lockfile --other-arg\n",
              "Dockerfile.newline": "RUN yarn install\n",
              "Dockerfile.newline-with-more-after": "RUN yarn install \\\n --other-arg\n",
              "Dockerfile.newline-multiple-args": "RUN yarn install \\\n --other-arg\n",
            },
      );
    });
