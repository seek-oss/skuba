 ...
 */
export const mergePreset = <AdditionalOptions extends keyof Config.InitialOptions>({
  projects,
  ...options
}: Pick<Config.InitialOptions, AdditionalOptions | DefaultOptions>): Config.InitialOptions => {
