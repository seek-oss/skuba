...
export const TEMPLATE_NAMES_WITH_BYO = [...TEMPLATE_NAMES, "github →", "seek →"] as const;
...
export const TEMPLATE_DOCUMENTATION_CONFIG: Record<TemplateName, TemplateDocumentationConfig> = {
  "express-rest-api": {
    added: "3.8.0",
    filename: "api.md",
  },
