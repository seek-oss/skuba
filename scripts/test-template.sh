...
jq ".dependencies[\"eslint-config-skuba\"] = \"file:${eslint_config_skuba_tar}\" | .dependencies[\"@skuba-lib/api\"] = \"file:${skuba_lib_api_tar}\" | .dependencies[\"@skuba-lib/vitest-koa-mocks\"] = \"file:${vitest_koa_mocks_tar}\"" package.json > package.json.tmp
