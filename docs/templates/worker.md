...
- [9.2.0](https://github.com/seek-oss/skuba/releases/tag/v9.2.0): Remove template ([#1789](https://github.com/seek-oss/skuba/pull/1789))

  It is recommended to use the `lambda-sqs-worker-cdk` template instead.

- [9.2.0](https://github.com/seek-oss/skuba/releases/tag/v9.2.0): Add `git` to the base Docker image ([#1775](https://github.com/seek-oss/skuba/pull/1775))

- [9.2.0](https://github.com/seek-oss/skuba/releases/tag/v9.2.0): Upgrade `aws-cdk` and `aws-cdk-lib` to `^2.167.1` ([#1740](https://github.com/seek-oss/skuba/pull/1740))

- [9.2.0](https://github.com/seek-oss/skuba/releases/tag/v9.2.0): Fix failing unit test and add `start` command ([#1724](https://github.com/seek-oss/skuba/pull/1724))

- [9.2.0](https://github.com/seek-oss/skuba/releases/tag/v9.2.0): Upgrade to Node 22 ([#1789](https://github.com/seek-oss/skuba/pull/1789))

- [9.2.0](https://github.com/seek-oss/skuba/releases/tag/v9.2.0): Align with latest AWS tagging guidance ([#1782](https://github.com/seek-oss/skuba/pull/1782))
