...
- [16.2.0](https://github.com/seek-oss/skuba/releases/tag/v16.2.0): Abstract CDK stack normalisation ([#2418](https://github.com/seek-oss/skuba/pull/2418))
...
- [15.0.0](https://github.com/seek-oss/skuba/releases/tag/v15.0.0): Update Datadog secret configuration to support custom KMS keys ([#2239](https://github.com/seek-oss/skuba/pull/2239))
