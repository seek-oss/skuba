...
- [16.4.0](https://github.com/seek-oss/skuba/releases/tag/v16.4.0): Switch to repoName for custom conditions templating ([#2565](https://github.com/seek-oss/skuba/pull/2565) [`f9f0911`](https://github.com/seek-oss/skuba/commit/f9f09115aa7e5d7171a9bc826f4b1a89ad3f4781))

- [16.4.0](https://github.com/seek-oss/skuba/releases/tag/v16.4.0): Pin tsdown `attw` to `{ profile: 'node16' }` so new packages keep node16-compatible checks instead of tsdown's `esm-only` default. ([#2574](https://github.com/seek-oss/skuba/pull/2574) [`8d3c9a7`](https://github.com/seek-oss/skuba/commit/8d3c9a77467c8ffb5fb0c8302dc81a4f873583fc))

- [16.4.0](https://github.com/seek-oss/skuba/releases/tag/v16.4.0): Migrate to changesets/action action v2 ([#2580](https://github.com/seek-oss/skuba/pull/2580) [`f35cea0`](https://github.com/seek-oss/skuba/commit/f35cea056795337e703cf6f78317c9aa051b5888))

- [16.3.0](https://github.com/seek-oss/skuba/releases/tag/v16.3.0): Remove SEEK-specific built-in templates ([#2476](https://github.com/seek-oss/skuba/pull/2476))
...
- [16.0.0](https://github.com/seek-oss/skuba/releases/tag/v16.0.0): Migrate to ESM ([#2355](https://github.com/seek-oss/skuba/pull/2355))

- [16.0.0](https://github.com/seek-oss/skuba/releases/tag/v16.0.0): Resolve `#src` alias to `./src` directory during package builds ([#2322](https://github.com/seek-oss/skuba/pull/2322))

- [15.0.0](https://github.com/seek-oss/skuba/releases/tag/v15.0.0): Migrate to `tsdown` for bundling ([#2193](https://github.com/seek-oss/skuba/pull/2193))
...
- [12.2.0](https://github.com/seek-oss/skuba/releases/tag/v12.2.0): Switch to pnpm/action-setup in workflows ([#2055](https://github.com/seek-oss/skuba/pull/2055))

- [12.1.0](https://github.com/seek-oss/skuba/releases/tag/v12.1.0): actions/checkout v5 ([#2016](https://github.com/seek-oss/skuba/pull/2016))
