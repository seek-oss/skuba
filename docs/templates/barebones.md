...
Packs enough Buildkite, Docker and Vitest configuration to put you on track for production.
...
- [16.2.0](https://github.com/seek-oss/skuba/releases/tag/v16.2.0): Use `repoName` for templating ([#2442](https://github.com/seek-oss/skuba/pull/2442))
